...
class CGSMAlphabet
{
	...
	public static void main(String args[])
	{
		...
		for (i = 1; i <= 160; i ++)
		{
			...
			for (j = 0; j < i; j ++) s += "0";
			ss = textToPDU(s);
			if (ss.charAt(ss.length() - 1) == '0' && ss.charAt(ss.length() - 2) == '0')
			{
				System.out.println(s.length());
			}
		}
			// System.out.println("New Encoding: " + textToPDU("1234567 "));
			// System.out.println("Old Encoding: " + textToPDU__OLD__("1234567 "));
	}
}
